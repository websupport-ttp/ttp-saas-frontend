...
export default function VisaSuccessRedirect() {
  ...
  useEffect(() => {
    ...
    const newUrl = `/success?service=visa${reference ? `&reference=${reference}` : ''}`
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <p className="text-gray-600">Redirecting to application confirmation...</p>
      </div>
    </div>
  )
}