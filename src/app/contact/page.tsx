...
// Above-fold animation — uses rAF to ensure browser paints initial state first
function useOnMount(delay = 150) {
  const [triggered, setTriggered] = useState(false)
  useEffect(() => {
    let t: ReturnType<typeof setTimeout>
    const raf = requestAnimationFrame(() => { t = setTimeout(() => setTriggered(true), delay) })
...
// Proper SVG components — no JSX-in-object issues
const FacebookIcon = () => (
...
export default function ContactPage() {
  ...
  const heroMounted = useOnMount(150)
      ...
      <main>
        ...
        <section className="relative overflow-hidden" style={{ backgroundColor: '#141b34' }}>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center"
            style={{ opacity: heroMounted ? 1 : 0, transform: heroMounted ? 'translateY(0)' : 'translateY(30px)', transition: 'opacity 0.7s ease, transform 0.7s ease' }}>
              ...
              <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-sm border border-gray-100 h-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="name" className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Full Name <span style={{ color: '#e21e24' }}>*</span></label>
                    ...
                    <div>
                      <label htmlFor="email" className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Email <span style={{ color: '#e21e24' }}>*</span></label>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      <label htmlFor="subject" className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Subject <span style={{ color: '#e21e24' }}>*</span></label>
                  ...
                  <div>
                    <label htmlFor="message" className="block text-xs font-semibold text-gray-600 uppercase tracking-wider mb-2">Message <span style={{ color: '#e21e24' }}>*</span></label>
